...
public class tptp_tester {
	...
	case Negation:
		...
		boundVariableTerm = (SimpleTptpParserOutput.Term)out.createVariableTerm(boundVariable);
		switch (quantifier) {
		case Exists: return substituteFormula(getGammaX(formula),boundVariableTerm,term,out);
		default: throw new Error("Unexpected case: " + formula.toString());
		}
	    default: throw new Error("Unexpected case: " + formula.toString());		
	    }
	...
	case Negation:
		...
		boundVariableTerm = (SimpleTptpParserOutput.Term)out.createVariableTerm(boundVariable);
		switch (quantifier) {
		case ForAll: return substituteFormula(getDeltaX(formula),boundVariableTerm,term,out);
		default: throw new Error("Unexpected case: " + formula.toString());
		}
	    default: throw new Error("Unexpected case: " + formula.toString());		
	    }
